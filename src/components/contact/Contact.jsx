...
export default function Contact() {
  ...
  // useRef يستخدم للوصول إلى عناصر DOM مباشرة في React
  const form = useRef();

  const sendEmail = (e) => {
    e.preventDefault(); // منع الإرسال الافتراضي للفورم الذي يسبب إعادة تحميل الصفحة
    ...
    emailjs.sendForm(serviceId, templateId, form.current, publicKey)
      .then((result) => {
        ...
        e.target.reset(); // لإعادة تعيين حقول الفورم بعد الإرسال
      }, (error) => {
            ...
            <form ref={form} onSubmit={sendEmail} className="php-email-form">
              <div className="row">
                <div className="col-md-6 form-group">
                  {/* تأكد من أن كل input له name مطابق للمتغير في قالب EmailJS */}
