...
import  { useEffect } from 'react'; // يجب استيراد useEffect
...
        
        // بما أن قسم Testimonials موجود أيضاً في هذا المكون، قد تحتاج لاستدعاء تهيئة السلايدر الخاص به أيضاً هنا
        if (typeof window.Swiper !== 'undefined') {
            new window.Swiper('.testimonials-slider', {
                // ... بقية خيارات Testimonials Slider
            });
        }
    }, []); // سيتم التشغيل مرة واحدة فقط عند تحميل المكون
...
            {/* **تم تعديل src للإشارة إلى المسار من مجلد public مباشرة** */}
